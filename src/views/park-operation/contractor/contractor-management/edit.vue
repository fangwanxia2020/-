  ...
  <div class="edit-content">
    <div class="edit-content-top">
      ...
      <div class="content">
        ...
        <div class="content-box">
          <div class="content-title">
            <div class="cl-hea-title">特种作业</div>
          </div>
          <el-form
            ref="cardForm"
  ...
  methods: {
        ...
        if (valid) {
          ...
          this.$refs["cardForm"].validate((valid) => {
            if (valid) {
              ...
              let resData = {
                ...this.baseForm,
                picId: this.machineImgList[0]
                  ? this.machineImgList[0].response.data.id
                  : null,
              };
              if (this.$route.query.id) {
    ...
    getDetails(id) {
      getFilingPerson(id).then(async (res) => {
        ...
        console.log(this.machineImgList, "这是哪里123");
        this.title = "修改—人员基础信息" + "—" + this.baseForm.name;
        // console.log(res1);
