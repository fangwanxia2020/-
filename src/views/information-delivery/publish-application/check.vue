<template>
  <div class="edit-content">
        ...
        <div class="content-box">
          ...
          >
            <el-row>
              <el-col
                :span="12"
                style="border-right: 1px solid #eee; padding: 0 30px 0 0"
              >
              ...
              <el-col :span="12" style="padding: 0 30px">
                ...
                <div style="margin-left: 30px">
                  <div class="approval-box" style="display: flex">
                    <span class="approval-box-top">审批状态：</span>
                    <span>待审批</span>
                    <!-- <el-image
                      src="@/assets/images/approval/used.png"
                      class="approval-box-img"
                    >
                    </el-image> -->
                  </div>
                  <!-- <div class="approval-box">
                    <span class="approval-box-top">审批意见：</span>
                    <span>审批通过,情况属实</span>
                  </div>
                  <div class="approval-box">
                    <span class="approval-box-top">审批人：</span>
                    <span>林殊</span>
                  </div>
                  <div class="approval-box">
                    <span class="approval-box-top">审批人单位：</span>
                    <span>华谊新材料</span>
                  </div> -->
                  <!-- <div class="approval-box">
                    <span class="approval-box-top">审批时间：</span>
                    <span>2022-01-01 12:12</span>
                  </div> -->
                  <div class="approval-box">
                    <span class="approval-box-top">发起人：</span>
                    <span>黄善鸿</span>
                  </div>
                  <div class="approval-box">
                    <span class="approval-box-top">发起人单位：</span>
                    <span>华谊新材料</span>
                  </div>
                  <div class="approval-box">
                    <span class="approval-box-top">发起时间：</span>
                    <span>2022-01-01 12:12</span>
                  </div>
                </div>
              </el-col>
    ...
    <div class="footer">
      <!-- <el-button @click="handleBack">编辑</el-button> -->
      <el-button type="primary" @click="save">编辑</el-button>
