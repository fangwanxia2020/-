<template>
  <div class="area-analyse">
    ...
    <div class="body-content">
      <h3 ref="title" class="body-content-title">人员进出分析</h3>
...
export default {
  ...
  data() {
    return {
      ...
      videoList: [
        ...
        { num: 0, url: top2, name: "今日园内人数（人）" },
        { num: 0, url: top3, name: "今日实时人数（人）" },
        { num: 0, url: top4, name: "今日来访人数（人)" },
      ],
    };
  },
  watch: {
  ...
  methods: {
    ...
    getPeopleCountAll() {
      getPersonInOut4TypeCout().then((res) => {
