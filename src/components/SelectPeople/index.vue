...
export default {
  ...
  methods: {
    ...
    closeTagFun(tag) {
      console.log(tag, "tag---");
      console.log(this.selectPeople, "this.selectPeople---");
      this.selectPeople = this.selectPeople.filter((item) => {
        return item[this.dialogId] != tag[this.dialogId];
      });
      this.$emit("input", this.selectPeople);
    },
  },
