  ...
  <div class="cl-r-container">
    ...
    >
      ...
      <el-table-column label="性别" prop="genderName" show-overflow-tooltip>
        <template slot-scope="scope">
          {{
            scope.row.sysPersonBaseDto && scope.row.sysPersonBaseDto.genderName
          }}
        </template>
      </el-table-column>
      <el-table-column label="单位" prop="orgName" show-overflow-tooltip>
        <template slot-scope="scope">
          {{ scope.row.locCardDto.orgName }}
        </template>
      </el-table-column>
      <el-table-column
        label="身份证号"
