  ...
  <div class="people-dialog-view">
    ...
    >
      <template #search>
        <span
          v-if="!contractorId"
          class="el-form-item el-form-item--medium search-item"
        >
...
export default {
  ...
  created() {
    this.getDicts("hse_personType").then(
      (response) => (this.personTypeOptions = response.data),
    );
