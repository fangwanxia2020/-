...
export default {
  ...
  computed: {
    isAdd() {
      return this.pageType == "waybill-report-add";
    },
    isCheck() {
      return this.pageType == "waybill-report-check";
    },
  },
  watch: {
    $route: {
  ...
  methods: {
    ...
    getDetail() {
      let that = this;
      getWaybillInfo(this.$route.query.id).then((res) => {
        ...
        this.$nextTick(() => {
          ...
          that.$set(this.listItem, "consignee", consignee);
          ...
          if (
            ...
            city2 = res.data.destinationCity;
          }
          console.log(city2);
          ...
          let arr = [shipment, shipment1, shipment2];
          let arr1 = [destination1, destination2, destination3];
          let origin = {};
          let destination = {};
          //起运地
          origin.area = arr;
