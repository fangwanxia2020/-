<template>
  <div class="area-analyse">
    ...
    <div class="body-content">
      <h3 ref="title" class="body-content-title">车辆入园趋势</h3>
...
import {
  getVehicleNowCount,
  getVehicleWeekCount,
  getVehicleMonthCount,
  getVehicleCustomCount,
...
export default {
  ...
  methods: {
    ...
    getDetail() {
      ...
      let fn = getVehicleNowCount;
      if (this.tabPos == "today") {
        fn = getVehicleNowCount;
      } else if (this.tabPos == "toweek") {
        fn = getVehicleWeekCount;
      } else if (this.tabPos == "tomonth") {
        fn = getVehicleMonthCount;
      } else if (this.tabPos == "custom") {
        fn = getVehicleCustomCount;
      }
      if (
        this.tabPos == "today" ||
        this.tabPos == "toweek" ||
